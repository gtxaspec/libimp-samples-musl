...
int main(int argc, char *argv[])
{
	...
	if (argc < 2) {
		IMP_LOG_ERR(TAG, "Usage:%s sensor_type, sensor_type support ov9712,ov9713,ov9750,ar0141,gc1004,jxh42,sc1035,sc1045,imx307\n", argv[0]);
		return -1;
	}
	...
	for (i = 0; i < STREAM_CNT; i++) {
		// 5.1、获取编码channel参数
		ret = sample_res_encoder_param_default(&encchn_attr[i], encchn_type[i], ENC_RC_MODE_CBR,
