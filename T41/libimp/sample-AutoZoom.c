...
/*
 * This example is used to test the image zooming function of the IMP_ISP_Tuning_SetAutoZoom interface.
 * The zoom_test array contains the magnification factors to be tested
 * With the ISP frequency set to 300M strong, the maximum zoom factor is between 4 and 5 times.
 */
...
#if 1
		// In the default case, the sample captures 200 frames, adjusting the magnification factor every 30 frames.
