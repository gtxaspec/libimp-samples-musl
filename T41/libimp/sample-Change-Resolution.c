...
/*
 * The purpose of this example is to switch the output bitstream from 1080p+720p to 720p+360p, and then to 360p+320x240. 
 * Both the main and secondary bitstreams use the method of destroying and recreating the encoder and framesource to switch the resolution.
 */
