...
/*
This example mainly aims to achieve electronic zoom function using Fcrop. 
Due to the limitation of encoding resolution, currently it can only zoom in by about 10 times.
 */
