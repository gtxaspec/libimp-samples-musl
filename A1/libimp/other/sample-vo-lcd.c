...
IMP_S32 sample_enable_vo_all(SAMPLE_VO_MODE_E enVoMode)
{
	...
	stVoPubAttr.stSyncInfo.u16Vbp = 15;
	stVoPubAttr.stSyncInfo.u16Vfp = 134;
	stVoPubAttr.stSyncInfo.u16Hact = 1024;
	stVoPubAttr.stSyncInfo.u16Hbp = 158;
	stVoPubAttr.stSyncInfo.u16Hfp = 217;
	stVoPubAttr.stSyncInfo.u16Hpw = 1;
	stVoPubAttr.stSyncInfo.u16Vpw = 1;
