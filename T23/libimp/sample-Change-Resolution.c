...
/*
 * 此例目的是将输出码流720p+480p切换成480p+360p，再切换成360p+320x240
...
int main(int argc, char *argv[])
{
	...
	//init original resolution 1280x720 & 640x480
	...
	chn[1].fs_chn_attr.scaler.outheight = 480;
	chn[1].fs_chn_attr.picWidth = 640;
	chn[1].fs_chn_attr.picHeight = 480;
